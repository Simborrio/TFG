...
{
    CFE_MSG_CommandHeader_t CommandHeader; /**< \brief Command header */
} SAMPLE_APP_PingCmd_t;

typedef struct
{
    CFE_MSG_CommandHeader_t CommandHeader; /**< \brief Command header */
} SAMPLE_APP_GetSensorsCmd_t;
...
{
    CFE_MSG_TelemetryHeader_t    TelemetryHeader; /**< \brief Telemetry header */
    SAMPLE_APP_DataTlm_Payload_t Payload;         /**< \brief Telemetry payload */
} SAMPLE_APP_DataTlm_t;

typedef struct
{
    CFE_MSG_TelemetryHeader_t        TelemetryHeader; /**< \brief Telemetry header */
    SAMPLE_APP_SensorsTlm_Payload_t  Payload;         /**< \brief Telemetry payload */
} SAMPLE_APP_SensorsTlm_t;
