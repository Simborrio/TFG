...
/*
 * ----------------------------------------------------
 * Generated stub function for SAMPLE_APP_PingCmd()
 * ----------------------------------------------------
 */
CFE_Status_t SAMPLE_APP_PingCmd(const SAMPLE_APP_PingCmd_t *Msg)
{
    UT_GenStub_SetupReturnBuffer(SAMPLE_APP_PingCmd, CFE_Status_t);

    UT_GenStub_AddParam(SAMPLE_APP_PingCmd, const SAMPLE_APP_PingCmd_t *, Msg);

    UT_GenStub_Execute(SAMPLE_APP_PingCmd, Basic, NULL);

    return UT_GenStub_GetReturnValue(SAMPLE_APP_PingCmd, CFE_Status_t);
}
/*
 * ----------------------------------------------------
