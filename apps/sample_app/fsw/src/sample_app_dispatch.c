    ...
    */
    switch (CommandCode)
    {
        ...
        case SAMPLE_APP_DISPLAY_PARAM_CC:
            ...
            break;
        case SAMPLE_APP_PING_CC:
            if (SAMPLE_APP_VerifyCmdLength(&SBBufPtr->Msg, sizeof(SAMPLE_APP_PingCmd_t)))
            {
                SAMPLE_APP_PingCmd((const SAMPLE_APP_PingCmd_t *)SBBufPtr);
            }
            break;
        case SAMPLE_APP_GET_SENSORS_CC:
            if (SAMPLE_APP_VerifyCmdLength(&SBBufPtr->Msg, sizeof(SAMPLE_APP_GetSensorsCmd_t)))
            {
                SAMPLE_APP_GetSensorsCmd((const SAMPLE_APP_GetSensorsCmd_t *)SBBufPtr);
            }
            break;
        default:
